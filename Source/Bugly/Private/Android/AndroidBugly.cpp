...
jmethodID FAndroidBugly::PostCatchedExceptionMethod;
jmethodID FAndroidBugly::SetLogCacheMethod;
jmethodID FAndroidBugly::UpdateAppVersionMethod;
jmethodID FAndroidBugly::UpdateAppChannelMethod;
...
FAndroidBugly::FAndroidBugly()
{
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		PostCatchedExceptionMethod = FJavaWrapper::FindMethod(Env, FJavaWrapper::GameActivityClassID, "AndroidThunkJava_Bugly_PostCatchedException", "(Ljava/lang/String;)V", false);
		...
		UpdateAppChannelMethod = FJavaWrapper::FindMethod(Env, FJavaWrapper::GameActivityClassID, "AndroidThunkJava_Bugly_UpdateAppChannel", "(Ljava/lang/String;)V", false);
	}
}
...
void FAndroidBugly::PostCatchedException(const FString& InMsg)
{
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		auto MsgJava = FJavaHelper::ToJavaString(Env, InMsg);

		FJavaWrapper::CallVoidMethod(Env, FJavaWrapper::GameActivityThis, PostCatchedExceptionMethod, *MsgJava);
	}
}
...
void FAndroidBugly::UpdateChannel(const FString& InAppChannel)
{
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		auto AppChannelJava = FJavaHelper::ToJavaString(Env, InAppChannel);

		FJavaWrapper::CallVoidMethod(Env, FJavaWrapper::GameActivityThis, UpdateAppChannelMethod, *AppChannelJava);
	}
}
