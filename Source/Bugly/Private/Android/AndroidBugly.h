...
public:
	...
	virtual void PostCatchedException(const FString& InMsg);
	virtual void SetLogCache(int32 ByteSize) override;
	virtual void UpdateVersion(const FString& InAppVersion) override;
	virtual void UpdateChannel(const FString& InAppChannel) override;

	// JNI Methods
	static jmethodID InitCrashReportMethod;
	static jmethodID PostCatchedExceptionMethod;
	...
	static jmethodID UpdateAppChannelMethod;
};